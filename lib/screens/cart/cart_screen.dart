          ...
          builder: (context, cartProvider, child){
            return  Column(
              ...
              children: [
                ...
                }, width: Get.width * 0.300, height: 50.0,radius: 10.0,)
              ],
            ),
                ...
                Column(
                  children: [
                   cartProvider.items.isNotEmpty  ?  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        Container(
                          ...
                          child: ListTile(
                            ...
                            title: TextWidget(text: cartItem.product.title,size: 12.0,),
                            subtitle: Text('\$${cartItem.product.cost.toStringAsFixed(2)}'),
                            trailing: Row(
                    ...
                    ) : Center(child: TextWidget(text: "No Cart Item Found", size: 14.0)),
