...
class ItemsUploadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final imageUploadProvider = Provider.of<ImagePickProvider>(context,listen: false);
    final uploadProvider = Provider.of<ItemsUploadProvider>(context,listen: false);
    final uploadProgress = context.watch<ImagePickProvider>().uploadProgress;
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Consumer<ImagePickProvider>(
                     builder: (context, imageProvider, child){
                       return Column(
                         children: [
                           Container(
                             child: imageProvider.images != null && imageProvider.images!.isNotEmpty
                                 ? GridView.builder(
                  ...
                  CustomTextField(hintText: "product title", controller: titleController,fillColor: Colors.white,),
                      ...
                      return provider.isLoading == false ? ButtonWidget(
                          ...
                          onClicked: () async{
                            if(_key.currentState!.validate()) {
                              ...
                              if(imageUploadProvider.images!.isNotEmpty){
                                await imageUploadProvider.uploadImages(context);
                               await uploadProvider
                                    .uploadItems(
                                    downloadUrls: imageUploadProvider.downloadUrls,
                               ...
                               costController.clear();
                                ...
                                showSnackBar(title: "Alert!!!", subtitle: "Please select product images");
                              }

                            }
                          },
                          width: MediaQuery.sizeOf(context).width, height: 50.0) :
                      ButtonLoadingWidget(loadingMesasge: "uploading",width: MediaQuery.sizeOf(context).width, height: 50.0);
                    },
                  ),
